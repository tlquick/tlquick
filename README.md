...
| ------------- | ------------- |
| [SpringBootDemo](https://github.com/tlquick/SpringBootDemo) | V1: Demo using Hibernate to connect to Postgres database. Swagger used to generate API documentation. V2: Docker Compose used to manage db and app containers. V3: Host postgres db on render and use docker container to host spring boot on render - live site, circa 2023 |
